...
function App() {
  return (
    <div className="App flex flex-col font-Poppins bg-gray-100 dark:bg-indigo-1000 transition duration-500">
      <Helmet>
      ...
      <button className=" bg-blue-600 z-30 bottom-28 sm:bottom-8 right-12 fixed rounded-2xl">
