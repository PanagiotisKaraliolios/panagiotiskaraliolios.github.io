    ...
    return (
        ...
        <div id="nav" className=" grid sm:hidden grid-cols-3 p-6 rounded-t-3xl bg-white dark:bg-indigo-900 z-50 fixed w-screen shadow-xlupper transition-all opacity-0 -bottom-full " >
            ...
            <SmallNavButton Text={"Home"}
             Icon={<svg className=" fill-black dark:fill-gray-100" xmlns="http://www.w3.org/2000/svg" width="31.881" height="32.001" viewBox="0 0 31.881 32.001">
            ...
            Icon={<svg className=" fill-black dark:fill-gray-100" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
            ...
            <SmallNavButton Text={"Skills"}
             Icon={<svg className=" fill-black dark:fill-gray-100" xmlns="http://www.w3.org/2000/svg" width="22.858" height="32.001" viewBox="0 0 22.858 32.001">
            ...
            <SmallNavButton Text={"Services"}
             Icon={<svg className=" fill-black dark:fill-gray-100" xmlns="http://www.w3.org/2000/svg" width="32.016" height="32.001" viewBox="0 0 32.016 32.001">
            ...
            <SmallNavButton Text={"Contact Me"}
             Icon={<svg className=" stroke-black dark:stroke-gray-100" xmlns="http://www.w3.org/2000/svg" width="34.053" height="34.034" viewBox="0 0 34.053 34.034">
            ...
            <button className="flex justify-center content-center" onClick={() => { window.document.getElementById('nav').style.bottom='-100%'
                ...
                <svg className=" self-center fill-blue-600 dark:fill-blue-500" xmlns="http://www.w3.org/2000/svg" width="18.004" height="18.003" viewBox="0 0 18.004 18.003">
