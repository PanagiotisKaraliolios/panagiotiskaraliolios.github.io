	...
	return (
		<div
			...
			<div className='flex flex-col items-center justify-center space-y-2 '>
				<div className='text-3xl font-semibold text-gray-800 dark:text-gray-100'>Skills</div>

				<div className='font-medium text-gray-600 dark:text-gray-500'>My technical knowledge</div>
			</div>
			...
			<div className='flex flex-col justify-center space-y-20 lg:flex-row lg:space-y-0 lg:space-x-20'>
				<Fade
					...
					<div className='flex flex-col items-center space-y-10 md:pr-8'>
						...
						<div className='flex-col content-center m-auto space-y-6 text-gray-700 dark:text-gray-400'>
