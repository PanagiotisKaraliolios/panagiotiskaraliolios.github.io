...
function About() {
    ...
    return (
        <div id="Contact Me" className=" flex flex-col justify-center items-center p-20 sm:p-10 space-y-32 sm:my-20">
            ...
            <div className=" flex flex-col lg:flex-row  justify-center items-center lg:items-start space-y-28 lg:space-y-0 lg:space-x-40">

                <div className="space-y-5">
                    <div className="flex items-center space-x-5 flex-wrap">
                        <svg className="fill-blue-600" xmlns="http://www.w3.org/2000/svg" width="36.737" height="36.733" viewBox="0 0 36.737 36.733">
                    ...
                    <div className="flex items-center space-x-5">
                        <svg className="stroke-blue-600" xmlns="http://www.w3.org/2000/svg" width="38.754" height="38.767" viewBox="0 0 38.754 38.767">
                    ...
                    <div className="flex items-center space-x-5">
                        <svg className="stroke-blue-600" xmlns="http://www.w3.org/2000/svg" width="38.737" height="45.834" viewBox="0 0 38.737 45.834">
