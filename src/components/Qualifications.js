...
function Qualifications() {
	...
	return (
		<div
			id='Qualifications'
			className='flex flex-col items-center justify-center p-10 pb-20 space-y-32 sm:p-10 sm:my-20 sm:pb-0'>
			<div className='flex flex-col items-center justify-center space-y-2 '>
				<div className='text-3xl font-semibold text-gray-800 dark:text-gray-100'>Qualifications</div>

				<div className='font-medium text-gray-600 dark:text-gray-500'>My personal journey</div>
			</div>
				...
				<div className='flex items-center justify-center gap-x-10'>
					<button
						...
						className={`flex items-center space-x-10 text-2xl ${
							visibleSection === 'education' ? 'text-blue-600' : 'text-gray-700 dark:text-gray-500'
						}`}>
						<svg
							className={` ${
								visibleSection === 'education' ? ' fill-blue-600' : 'fill-gray-700 dark:fill-gray-500'
							}`}
							id='education'
						...
						<div className='hidden font-semibold sm:flex'>Education</div>
					</button>

					<button
						onClick={changeVisibleSectionToWork}
						className={`flex items-center space-x-10 text-2xl ${
							visibleSection === 'work' ? 'text-blue-600' : ' text-gray-700 dark:text-gray-500'
						}`}>
						<svg
							className={` ${
								visibleSection === 'work' ? ' fill-blue-600' : 'fill-gray-700 dark:fill-gray-500'
							}`}
							id='briefcase-line'
							xmlns='http://www.w3.org/2000/svg'
							width='58.193'
						...
						<div className='hidden font-semibold sm:flex'>Work</div>
					</button>
				</div>

				{visibleSection === 'education' ? (
					<div className='flex flex-col pt-20 sm:flex-row sm:space-x-10 h-96'>
						<div className='flex flex-col space-y-2'>
							...
							<div className='flex items-center font-medium text-gray-600 dark:text-gray-500'>
								<svg
						...
						<svg
							className='hidden transform translate-y-2 fill-blue-600 h-max sm:flex'
							xmlns='http://www.w3.org/2000/svg'
							width='21'
							height='158.5'
						...
						<div className='flex flex-col space-y-2 place-self-end pt-36'>
							<div className='text-2xl font-semibold text-gray-800 transform -translate-y-16 dark:text-gray-100'>
								Applied Inf. Technology BSc
							</div>
							<div className='font-medium text-gray-700 transform -translate-y-16 dark:text-gray-300'>
								University of Macedonia
							</div>
							<div className='flex items-center font-medium text-gray-600 transform -translate-y-16 dark:text-gray-500'>
								<svg
									className='fill-gray-600 dark:fill-gray-500 '
									id='calendar'
									xmlns='http://www.w3.org/2000/svg'
					...
					<div className='flex flex-row items-center justify-center pt-20 space-x-10 h-96'>
						<div className='text-xl font-semibold dark:text-gray-100'>Looking forward to it...😃</div>
					</div>
				)}
			</div>
		</div>
