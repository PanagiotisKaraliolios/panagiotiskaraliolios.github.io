...
function BackEndInfoCard() {
    return (
        <div id="BackEndInfoCard" className="flex cursor-pointer items-center content-center p-3 justify-center z-50 fixed w-full h-full bg-gray-500 bg-opacity-30 backdrop-filter backdrop-blur-sm transition-all duration-500 opacity-0 invisible "
        onClick={()=> {
