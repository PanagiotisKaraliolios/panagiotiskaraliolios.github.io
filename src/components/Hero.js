...
function Hero() {
	...
	return (
		<div
			id='Home'
			className=' md:flex md:justify-evenly sm:my-20'>
			<div
				id='animation1'
				className='absolute left-0 z-0 hidden w-96 md:flex dark:hidden'
			/>
			<div
				id='animation2'
				className='absolute z-0 w-80 bottom-20 md:left-40 dark:hidden'
			/>
			<div
				id='animation3'
				className='absolute z-0 flex w-6/12 dark:hidden'
			/>

			<div className='z-20 flex flex-wrap items-center justify-center m-10 sm:flex-row sm:justify-around sm:flex-nowrap'>
				<div className='flex flex-col order-1 m-auto sm:p-10 sm:order-none'>
					<a
						className='pb-4 w-max'
						target='_blank'
						rel='noreferrer'
				...
				<div className='z-10 flex flex-col justify-around order-5 max-w-xs pt-10 space-y-4 justify-self-center sm:order-none'>
					<div className='text-4xl font-semibold text-gray-800 dark:text-gray-100'>Hi, I am Panos</div>
					...
					<div className='text-gray-600 font-regular dark:text-gray-500'>
						Web Design and application development experience, producing high quality work.
					</div>

					<button
						onClick={scrollToSection}
						className='z-20 flex items-center p-3 space-x-2 text-white bg-blue-600 w-max justify-evenly rounded-2xl'>
						<div>Contact Me</div>
					...
					<div className='pt-20'>
						<div className='flex items-center space-x-5 text-gray-700 animate-bounce dark:text-white w-max justify-evenly rounded-3xl '>
							<svg
				...
				<div className='order-2 w-48 m-auto sm:order-none sm:w-auto'>
					<img
						className=''
						src={heroImage}
						alt=''
