...
function FrontEndInfoCard() {
    return (
        <div id="FrontEndInfoCard" className="flex cursor-pointer items-center content-center justify-center p-3 z-50 fixed w-full h-full bg-gray-500 bg-opacity-30 backdrop-filter backdrop-blur-sm transition-all duration-500 opacity-0 invisible"
        onClick={()=> { window.document.getElementById('FrontEndInfoCard').style.visibility='hidden';
            ...
            <div className=" bg-gray-100 dark:bg-indigo-900 p-5 sm:px-20 space-y-3 rounded-2xl">
                ...
                <div className="flex items-center space-x-3">
                    <svg className="min-w-min fill-current text-blue-500" id="check2-circle" xmlns="http://www.w3.org/2000/svg" width="20.903" height="19.41" viewBox="0 0 20.903 19.41">
