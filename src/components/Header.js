...
function Header() {
	...
	return (
		<div className="flex w-screen sm:w-auto bg-gray-100 dark:bg-indigo-1000 justify-around bottom-0 sm:top-0 fixed sm:sticky z-40 p-5 sm:p-8 shadow-xlupper  sm:shadow-xl">
			...
			<div
				className="sm:transform hover:-rotate-12 transition duration-500 ease-in-out flex
			...
			<div className="flex space-x-6">
				...
				<button onClick={() => toggleMode()} className=" w-7 2xl:w-12">
				...
				<button
					...
					onClick={() => {
						window.document.getElementById("nav").style.bottom =
							"0";
						window.document.getElementById("nav").style.opacity =
							"100";
					}}
				>
					{!darkMode ? (
