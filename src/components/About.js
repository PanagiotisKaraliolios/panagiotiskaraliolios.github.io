...
function About() {
	return (
		<div
			id="About"
			className=" flex flex-col justify-center items-center p-10 sm:p-10 space-y-32 sm:my-20"
		>
			...
			<div className=" flex flex-col md:flex-row justify-center items-center space-y-10 md:space-y-0 md:space-x-20 lg:space-x-40">
				...
				<div className=" flex flex-col justify-center items-center max-w-md space-y-10">
					<div className="dark:text-gray-400 break-words ">
						...
						technology with dozens of classroom hours in software
						engineering and system development related courses.
						Seeking to utilize my skills and gain further
						experience.
					</div>
